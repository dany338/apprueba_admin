...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => '<div class="pull-left">'.Html::img('@web/images/logo.PNG', ['alt' => 'Enunciados', 'width'=>'35','height'=>'30']).'</div> <div class="pull-left">Enunciados</div>',
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'Perfil', 'image' => FA::icon('user'), 'url' => ['/user/settings/profile'], 'labelOptions' => ['icon' => FA::icon('user')]];
        $menuItems[] = '<li>'
